...
//                startActivity(new Intent(LoginActivity.this, RegisterActivity.class));
    ...
    protected Dialog onCreateDialog(int id) {
        switch (id) {
            case DIALOG_ALERT:
                ...
                builder.setMessage("You want to register");
                builder.setCancelable(true);
                builder.setPositiveButton("Driver", new OkOnClickListener());
                builder.setNegativeButton("Client", new CancelOnClickListener());
    ...
    private final class OkOnClickListener implements
            DialogInterface.OnClickListener {
        public void onClick(DialogInterface dialog, int which) {
            startActivity(new Intent(LoginActivity.this, RegisterDriver.class));
            finish();
        }
    }
